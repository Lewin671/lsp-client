 ...
 */
class SampleWorkspace implements IWorkspace {
    rootUri: string;
 ...
 * Host implementation
 */
class TypeScriptHost implements IHost {
...
async function main() {
    ...
    try {
        ...
        transport = new StdioTransport('npx', ['typescript-language-server', '--stdio']);
        ...
        transport = new StdioTransport(tsserverPath, ['--stdio']);
    }
